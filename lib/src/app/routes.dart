...
import 'package:moneyApp/src/data/settings/authenticate.dart';
...
const intro1PageName = 'intro1';
const intro1PagePath = '/intro1';
const introPageName = 'intro';
const introPagePath = '/intro';
// ignore: constant_identifier_names
const LoginAuthName = 'logAuth';
const LoginAuthPath = '/logAuth';
